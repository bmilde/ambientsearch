...
def train_w2v(data_directory, corpus_path, wiki_text_output_path, word2vec_output_path, w2v_dim):
...
if __name__ == '__main__':
    ...
    train_w2v(args.data_directory, corpus_path, wiki_text_output_path, word2vec_output_path, args.w2v_dim)
